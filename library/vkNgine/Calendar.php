...
class vkNgine_Calendar
{
    ...
    {	
		if (!isset($options['year'])) $options['year'] = date('Y');
    	else $options['year'] = $options['year'];
		if (!isset($options['month'])) $options['month'] = date('m');
		else $options['month'] = $options['month'];
		if (!isset($options['day'])) $options['day'] = date('d');
		else $options['day'] = $options['day'];
